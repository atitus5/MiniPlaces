...
path_save = './saved_models/vgg_A_bn_efc'
start_from = ''
...
weights = {
    ...
    'wf11': tf.Variable(tf.random_normal([4096, 4096], stddev=np.sqrt(2./4096))),
